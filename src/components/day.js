              ...
              <ul class="trip-events__list">
                <li class="trip-events__item">
                  <div class="event">
                    ...
                    <h3 class="event__title">Taxi to ${newEvent.city}</h3>

                    <div class="event__schedule">
                      <p class="event__time">
                        <time class="event__start-time" datetime="2019-03-18T10:30">${newEvent.timeStart}</time>
                        &mdash;
                        <time class="event__end-time" datetime="2019-03-18T11:00">${newEvent.timeEnd}</time>
                      </p>
